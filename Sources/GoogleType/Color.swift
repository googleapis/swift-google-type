  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let red = CodingKeys(stringValue: "red")
    static let green = CodingKeys(stringValue: "green")
    static let blue = CodingKeys(stringValue: "blue")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Float.self, forKey: .green) {
      self.green = value
    }
    if let value = try container.decodeIfPresent(Swift.Float.self, forKey: .blue) {
      self.blue = value
    }
    self.alpha = try container.decodeIfPresent(GoogleCloudWKT.FloatValue.self, forKey: .alpha)
